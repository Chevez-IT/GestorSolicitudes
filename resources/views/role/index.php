                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Roles actuales</h6>
                                    <p class="text-sm mb-sm-0">Niveles de permisos que tienen nuestos usuarios</p>
                                </div>
                                ...
                                <table class="table align-items-center justify-content-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="text-secondary text-xs font-weight-semibold opacity-10 align-items-center justify-content-center text-center">Rol</th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2">
                                                            <div class="my-auto">
                                                                <h6 class="mb-0 text-sm"><?= $role['role_id'] ?></h6>
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td class="align-items-center justify-content-center text-center">
                                                        <p class="text-sm font-weight-normal mb-0"><?= $role['role_name'] ?></p>
                                                    </td>

                                                    <td class="align-items-center justify-content-center text-center">
                                                        <?php if ($role['role_status'] === 'Activo') : ?>
                                                    ...
                                                    <td class="align-items-center justify-content-center text-center">
                                                        <p class="text-sm font-weight-normal mb-0"><?= $role['role_creation'] ?></p>
                                                    </td>
                                                    <?php if ($role['role_modification'] === null) : ?>
                                                        <td class="align-items-center justify-content-center text-center">
                                                            <p class="text-sm font-weight-normal mb-0">Sin Modificar</p>
                                                        </td>
                                                    <?php else : ?>
                                                        <td class="align-items-center justify-content-center text-center">
                                                            <p class="text-sm font-weight-normal mb-0"><?= $role['role_modification'] ?></p>
                                                        </td>
                                                    <?php endif; ?>
                                                    <td class="align-items-center justify-content-center text-center">
                                                        <?php if ($role['role_status'] === 'Activo') : ?>
                                                            <form method="POST" action="<?= url("/role/update/status") ?>">
                                                                <input type="hidden" name="role-id" value="<?= $role['role_id'] ?>">
                                                                <input type="hidden" name="role-status" value="Inactivo">
                                                                <button type="submit" class="btn btn-danger py-2 px-3" data-bs-toggle="tooltip" data-bs-title="Inhabilitar"><i class="fa-solid fa-trash"></i></button>
                                                            </form>
                                                        <?php else : ?>
                                                            <form method="POST" action="<?= url("/role/update/status") ?>">
                                                                <input type="hidden" name="role-id" value="<?= $role['role_id'] ?>">
                                                                <input type="hidden" name="role-status" value="Activo">
                                                                <button type="submit" class="btn btn-success py-2 px-3" data-bs-toggle="tooltip" data-bs-title="Habilitar"><i class="fa-solid fa-trash-arrow-up"></i></button>
                                                            </form>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="role-name" class="col-form-label">Empresa</label>
                            <input type="text" class="form-control" type="text" id="role-name" name="role-name" placeholder="Administrador" require>
                        </div>
                    </div>
